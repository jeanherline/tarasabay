        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">User Cash-Outs</li>
                </ol>
                            ...
                            <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "</td>";
                                        echo "<td>
                                        <a href='https://tarasabay.000webhostapp.com/approveCashout.php?wallet_id=" . $row['wallet_id'] . "&amount=" . $row['amount'] . "' class='badge badge-success'><i class='fa fa-check'></i> Approve</a>
                                        <a href='https://tarasabay.000webhostapp.com/declineCashout.php?wallet_id=" . $row['wallet_id'] . "&amount=" . $row['amount'] . "' class='badge badge-danger'><i class='fa fa-ban'></i> Decline</a>
                                        </td>";
                                        echo "</tr>";
                                    }
                                    ?>
