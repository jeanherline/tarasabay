          ...
          <div class="card-body">
            ...
            <form method="POST">
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $first_name ?>" name="first_name" disabled><br>
              </div>
              <div class="form-group">

                <label for="last_name">Last Name</label>
                <input type="text" class="form-control" value="<?php echo $last_name ?>" name="last_name" disabled><br>
              </div>
              <div class="form-group">
              ...
              <div class=" form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $idtype ?>" name="id" disabled><br>
              </div>
              <div class="form-group">
             <label for="idnum">Valid ID Number</label>
              <input type="text" class="form-control" value="<?php echo $validid ?>" name="idnum" disabled><br>
              </div>
