                                    ...
                                    <tbody>
                                       ...
                                       WHERE c.status = 'pending' ORDER BY c.created_at DESC";
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>
    <a href='https://tarasabay.000webhostapp.com/approveCar.php?owner_id=" . $row['owner_id'] . "' class='badge badge-success'><i class='fa fa-check'></i> Approve</a>
    <a href='https://tarasabay.000webhostapp.com/disapproveCar.php?owner_id=" . $row['owner_id'] . "' class='badge badge-danger'><i class='fa fa-trash'></i> Decline</a>
</td>";
